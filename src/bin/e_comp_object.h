...
E_API Eina_Bool e_comp_object_iconic_preview_visibility_check(Evas_Object *obj);
E_API void e_comp_object_iconic_preview_add(Evas_Object *obj);
E_API void e_comp_object_iconic_preview_del(Evas_Object *obj);
E_API Evas_Object *e_comp_object_client_add(E_Client *ec);
E_API Evas_Object *e_comp_object_util_mirror_add(Evas_Object *obj);
E_API Evas_Object *e_comp_object_util_frame_mirror_add(Evas_Object *obj);
