...
_e_config_edd_init(Eina_Bool old)
{
   _e_config_gadcon_client_edd = 
     E_CONFIG_DD_NEW("E_Config_Gadcon_Client", E_Config_Gadcon_Client);
#undef T
#undef D
...
#define D _e_config_gadcon_edd
   ...
   _e_config_shelf_desk_edd = 
     E_CONFIG_DD_NEW("E_Config_Shelf_Desk", E_Config_Shelf_Desk);
#undef T
#undef D
...
#define D _e_config_shelf_edd
   ...
   _e_config_desklock_bg_edd = 
     E_CONFIG_DD_NEW("E_Config_Desklock_Background", E_Config_Desklock_Background);
#undef T
#undef D
...
#define D _e_config_desklock_bg_edd
   ...
   _e_config_desktop_bg_edd = 
     E_CONFIG_DD_NEW("E_Config_Desktop_Background", E_Config_Desktop_Background);
#undef T
#undef D
...
#define D _e_config_desktop_bg_edd
   ...
   _e_config_desktop_name_edd = 
     E_CONFIG_DD_NEW("E_Config_Desktop_Name", E_Config_Desktop_Name);
#undef T
#undef D
...
#define D _e_config_desktop_name_edd
   ...
   _e_config_desktop_window_profile_edd = 
     E_CONFIG_DD_NEW("E_Config_Desktop_Window_Profile", E_Config_Desktop_Window_Profile);
#undef T
#undef D
